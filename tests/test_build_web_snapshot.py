...
class WebSnapshotTest(unittest.TestCase):
    def test_snapshot_uses_current_project_facts(self):
        ...
        self.assertEqual("2026-07-27", snapshot["meta"]["article"]["date"])
        self.assertEqual("2026-07-24", snapshot["meta"]["fishDataDates"]["index"])
        self.assertEqual("2026-07-24", snapshot["meta"]["fishDataDates"]["sector"])
        ...
        self.assertEqual("2026-07-23", innovation_drug["previousDataDate"])
        self.assertEqual(0, innovation_drug["rankMovement"])
        self.assertEqual(0.75, innovation_drug["volumeRatio"])
    ...
    def test_direction_detail_exposes_evidence_and_lifecycle(self):
        ...
        self.assertTrue(innovation_drug["sourceImage"].endswith("sector_7bcb9645.jpg"))
